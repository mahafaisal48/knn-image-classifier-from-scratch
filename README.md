...
│   └── img2.jpg
```
> **Note:** The dataset is not included in this repo (large file size). Update the `data_path` variable in the script to point to your local dataset folder before running.
